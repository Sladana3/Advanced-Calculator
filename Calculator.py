...
open = Button(frame, text = "(", height=4, width=9, bg='white', font=35, command = lambda: button_press('('))
open.grid(row=0,column=4)
closed = Button(frame, text = ")", height=4, width=9, bg='white', font=35, command = lambda: button_press(')'))
closed.grid(row=0,column=5)
SR = Button(frame, text = "√()", height=4, width=9, bg='white', font=35, command = lambda: button_press('sqrt('))
SR.grid(row=3,column=4)
diff = Button(frame, text = "x^y", height=4, width=9, bg='white', font=35, command = lambda: button_press('**'))
diff.grid(row=1,column=4)
Cos = Button(frame, text = "cos()", height=4, width=9, bg='white', font=35, command = lambda: button_press('cos('))
Cos.grid(row=2,column=4)
Sin = Button(frame, text = "sin()", height=4, width=9, bg='white', font=35, command = lambda: button_press('sin('))
Sin.grid(row=2,column=5)
Tan = Button(frame, text = "tan()", height=4, width=9, bg='white', font=35, command = lambda: button_press('tan('))
Tan.grid(row=3,column=5)
pi = Button(frame, text = "π", height=4, width=9, bg='white', font=35, command = lambda: button_press('π'))
